...
public final class StudentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.test01.StudentRequest,
      com.test01.StudentResponse> getGetStudentsByAgeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getStudentsByAge",
      requestType = com.test01.StudentRequest.class,
      responseType = com.test01.StudentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.test01.StudentRequest,
      com.test01.StudentResponse> getGetStudentsByAgeMethod() {
    io.grpc.MethodDescriptor<com.test01.StudentRequest, com.test01.StudentResponse> getGetStudentsByAgeMethod;
      ...
      synchronized (StudentServiceGrpc.class) {
        if ((getGetStudentsByAgeMethod = StudentServiceGrpc.getGetStudentsByAgeMethod) == null) {
          StudentServiceGrpc.getGetStudentsByAgeMethod = getGetStudentsByAgeMethod = 
              io.grpc.MethodDescriptor.<com.test01.StudentRequest, com.test01.StudentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.test01.StudentService", "getStudentsByAge"))
  ...
  public static abstract class StudentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getStudentsByAge(com.test01.StudentRequest request,
        io.grpc.stub.StreamObserver<com.test01.StudentResponse> responseObserver) {
  ...
  public static final class StudentServiceBlockingStub extends io.grpc.stub.AbstractStub<StudentServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<com.test01.StudentResponse> getStudentsByAge(
        com.test01.StudentRequest request) {
  ...
  private static final int METHODID_GET_STUDENTS_BY_AGE = 0;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STUDENTS_BY_AGE:
          serviceImpl.getStudentsByAge((com.test01.StudentRequest) request,
              (io.grpc.stub.StreamObserver<com.test01.StudentResponse>) responseObserver);
          break;
        default:
